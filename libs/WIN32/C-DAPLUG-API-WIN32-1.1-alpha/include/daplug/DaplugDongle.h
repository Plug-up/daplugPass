...
*/
int DAPLUGAPI DAPLUGCALL Daplug_getFirstDongle();
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_authenticate(Keyset keys, int mode, char *div, char *chlg);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_computeDiversifiedKeys(Keyset keys, Keyset *div_keys, char *div);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_putKey(Keyset new_keys);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_deleteKey(int version);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_deleteFileOrDir(int id);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_selectFile(int id);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_selectPath(char *path);
...
*/
int DAPLUGAPI DAPLUGCALL Daplug_getRandom(int length, char* random);
